...
class TestSimilarity(unittest.TestCase):
    ...
    # return r'th component of a triangle weight function extending L indices
    # in each direction from the "origin". Add 1 to L to account for the
    # zero-offset ( r == 0 ) weight value
    ...
    def test_de_gelder_similarity(self):
        ...
        self.assertEqual(
            metric.de_gelder_similarity(scale_factor * f, scale_factor * g),
            metric.de_gelder_similarity(scale_factor * g, scale_factor * f))

        # The metric should indicate similarity. This vector should be more
        # similar to f than g
        h = [x - 0.1 for x in f]
